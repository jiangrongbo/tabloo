        ...
        <div class={("dropdown" + (state.active ? " is-active" : ""))}>
            <div class="dropdown-trigger">
                <button class="button is-small" onclick={onClick} onblur={onBlur}>
                    <span
                        class="dropdown-text">{(props.selectedIndex != undefined ? props.items[props.selectedIndex] : "")}</span>
                ...
                <div class="dropdown-menu customz">
                    <div class="dropdown-content">
                        {(props.items.map((item, index) =>
                                <a class={("dropdown-item modified" + (props.selectedIndex === index ? " is-active" : ""))}
                                   onmousedown={(event) => {
